...
**การเข้าหน้า admin (มีรหัสป้องกัน):** ตั้ง `admin_user` / `admin_pass` ใน `config.php` — เปิด `/adminammy300837/` เบราว์เซอร์จะถามรหัสก่อน (HTTP Basic Auth) ทั้งหน้า admin และ API ที่แก้ไขข้อมูลถูกล็อกไว้ ส่วนหน้าเว็บสาธารณะเปิดอ่านได้ปกติ
